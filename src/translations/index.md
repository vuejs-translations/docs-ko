...
## 번역에 기여하기 {#contributing-to-translations}

Vue 문서는 최근 대대적인 개정을 거쳤기 때문에, 다른 언어로의 번역이 아직 완료되지 않았거나 진행 중인 상태입니다.

커뮤니티의 번역 기여를 환영합니다. 번역 작업은 [vuejs-translations](https://github.com/vuejs-translations/) GitHub 조직에서 관리되고 있습니다. 기여에 관심이 있으시면, 먼저 [번역 가이드라인](https://github.com/vuejs-translations/guidelines/blob/main/README.md)을 확인하고 시작해 주세요.

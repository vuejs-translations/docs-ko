...
::: details 상세한 설명
스타일을 범위 지정하기 위해, Vue는 컴포넌트(component) 앨리먼트에 고유한 속성을 추가합니다, 예를 들어 `data-v-f3f3eg9` 같은 것입니다. 그런 다음 선택자가 수정되어 이 속성을 가진 일치하는 앨리먼트만 선택되도록 합니다 (예: `button[data-v-f3f3eg9]`).

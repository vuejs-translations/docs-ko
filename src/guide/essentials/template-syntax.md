...
가상 DOM 개념에 익숙하고 JavaScript의 원시적인 작동법을 선호하는 경우, JSX 지원 옵션을 사용하여 템플릿 대신 [렌더링 함수를 직접 작성](/guide/extras/render-function)할 수도 있습니다.
...
복잡한 동적인 인자를 전달해야 하는 경우 [computed 속성](./computed)을 사용하는 것이 더 나을 것입니다.
이에 대해서는 곧 다룰 것입니다.

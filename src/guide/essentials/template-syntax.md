...
여기서 `href`는 `v-bind` 디렉티브의 인자로서, 엘리먼트의 속성인 `href`에 `url`의 값을 바인딩한 것입니다. 간단하게 인자 앞의 `v-bind:`는 `:`로 줄여 쓸 수 있습니다.
...
<!-- https://www.figma.com/file/BGWUknIrtY9HOmbmad0vFr/Directive OR https://www.figma.com/file/al5C8iirhnfOKZ6izKwDw4/Directive-(ko-kr) -->

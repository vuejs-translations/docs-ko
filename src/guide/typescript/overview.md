...
`defineComponent()`는 `<script setup>` 없이 Composition API를 사용할 때 `setup()`에 전달되는 props의 타입도 추론할 수 있습니다:
...
- [Composition API에서 TS 사용](./composition-api)
- [Options API에서 TS 사용](./options-api)

...
- Vite는 타입스크립트를 변환하기 위해 [esbuild](https://www.typescriptlang.org/tsconfig#isolatedModules) 를 사용하고,  싱글 파일 변환 제한이 적용되기 때문에 <a><code data-md-type="codespan">compilerOptions.isolatedModules</code></a> 가 <code>true</code> 로 설정됩니다.
